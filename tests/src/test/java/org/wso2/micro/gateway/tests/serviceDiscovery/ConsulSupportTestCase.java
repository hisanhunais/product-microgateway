...
public class ConsulSupportTestCase extends BaseTestCase{
    ...
    private final static String INVALID_URL_AT_CONSUL_RESPONSE = "{\"fault\":{\"code\":\"101503\", \"message\":\"Runtime Error\", \"description\":\"Error connecting to the back end\"}}";
    ...
    public void start() throws Exception {
        ...
        cliExecutor.generatePassingFlag(label, project, "--enable-consul");
